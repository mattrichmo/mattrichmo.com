                  ...
                  <div className="row">
                    <div className="col-lg-11 offset-lg-1">
                      <div className="caption">
                        <h6 className="sub-title mb-30" data-swiper-parallax="-1000"><br /> {item.caption.subTitle}</h6>
                        <h1>
                          <a href={item.caption.link} className="animsition-link">
                            <span data-swiper-parallax="-2000">{item.caption.title}</span>
                          </a>
                        </h1>
                        <p>{item.caption.paragraph}</p>
                        {item.caption.button.enabled && 
                          <a href={item.caption.link} className="animsition-link">
                            <u>{item.caption.button.text}</u>
                          </a>
                        }
                      </div>
                    </div>
